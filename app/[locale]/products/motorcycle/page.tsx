    ...
    motoplay: {
      ...
      features: [
        ...
        },
        {
          ...
          text: "Use integrated navigation guidance for urban commuting, touring, and longer journeys.",
        },
        {
    ...
    products: [
      {
        ...
        category: "Premium IPS Motorcycle CarPlay System",
        description:
          "The premium model in the motorcycle smart-display line, uniting a premium IPS screen, high brightness, dual Bluetooth, Apple CarPlay, Android Auto and GPS in a water-resistant body.",
        features: [
          "Premium IPS",
          "High Brightness",
          "Dual Bluetooth",
      ...
      },
      {
        ...
        category: "5.5” IPS Motorcycle CarPlay System",
        description:
          "A smart riding display bringing a 5.5” IPS screen, wireless Apple CarPlay, Android Auto, Bluetooth and GPS together in a water-resistant body.",
        features: [
          "Wireless CarPlay",
          "Android Auto",
          "GPS",
      ...
      },
      {
        ...
        title: "APOLLON RX ONE",
        category: "Compact 1080P Motorcycle Camera",
        description:
          "A compact motorcycle camera combining 1080P recording, a wide-angle view, a G-sensor, parking mode and loop recording in a body sized for the motorcycle.",
        features: [
          "1080P",
          "Wide Angle",
          "G-Sensor",
    ...
    motoplay: {
      ...
      features: [
        ...
        },
        {
          ...
          text: "Şehir içi ulaşım, tur ve uzun yolculuklar için entegre navigasyon yönlendirmesini kullanın.",
        },
        {
    ...
    products: [
      {
        slug: "mdc-smart02",
        title: "APOLLON RIDE VISION",
        category: "Premium IPS Motosiklet CarPlay Sistemi",
        description:
          "Premium IPS ekran, yüksek parlaklık, çift Bluetooth, Apple CarPlay, Android Auto ve GPS özelliklerini suya dayanıklı bir yapıda birleştiren üst seviye motosiklet akıllı ekran sistemi.",
        features: [
          "Premium IPS",
          "Yüksek Parlaklık",
          "Çift Bluetooth",
      ...
      },
      {
        slug: "mdc-plus02",
        title: "APOLLON RIDE ONE",
        category: "5.5” IPS Motosiklet CarPlay Sistemi",
        description:
          "5.5” IPS ekran, kablosuz Apple CarPlay, Android Auto, Bluetooth ve GPS özelliklerini suya dayanıklı bir yapıda bir araya getiren akıllı sürüş ekranı.",
        features: [
          "Kablosuz CarPlay",
          "Android Auto",
          "GPS",
      ...
      },
      {
        slug: "moto-dash-cam-tr-v2",
        title: "APOLLON RX ONE",
        category: "Kompakt 1080P Motosiklet Kamerası",
        description:
          "1080P kayıt, geniş açı, G-Sensörü, park modu ve döngüsel kayıt özelliklerini motosiklete uygun kompakt bir gövdede bir araya getiren motosiklet kamerası.",
        features: [
          "1080P",
          "Geniş Açı",
          "G-Sensörü",
