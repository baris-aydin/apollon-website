...
export function SignatureAudioPreview({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="relative border-t border-border/30 py-32">
      {/* Background — overflow-hidden is on this wrapper, not the section */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute inset-0"
          style={{ background: "oklch(0.09 0.015 245 / 0.6)" }}
        />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_80%_at_50%_50%,oklch(0.22_0.08_245_/_0.4),transparent)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_40%_40%_at_50%_50%,oklch(0.70_0.12_65_/_0.04),transparent)]" />
      </div>
      ...
      <div className="section-container relative z-10">
        <div className="mx-auto max-w-3xl space-y-8 text-center">
          ...
          <h2 className="font-heading text-4xl font-bold leading-[1.15] tracking-tight md:text-6xl lg:text-7xl pb-[0.1em]">
            {c.heading}
          </h2>
