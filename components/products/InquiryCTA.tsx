...
export function InquiryCTA({
  ...
  if (variant === "banner") {
    return (
      <div className="relative overflow-hidden rounded-sm border border-bronze/20 p-8" style={{ background: "oklch(0.22 0.08 245 / 0.15)" }}>
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_0%_50%,oklch(0.70_0.12_65_/_0.06),transparent)]" />
